...
const seedIncompleteOrder = () => {
  ...
  db.prepare("INSERT INTO payments(id,order_id,payer,payee,amount,channel,status,paid_at,provider_transaction_id) VALUES (?,?,?,?,?,?,?,?,?)").run("PAY-PROD-MISSING-ITEMS", orderId, "测试采购主体", "持牌结算机构托管户", 10000, "机构监管结算", "已支付", t, null);
