...
const deployFiles = ["deploy/README.md", "deploy/shuzhi-v8530.env.example", "deploy/shuzhi-v8530.service", "deploy/nginx-shuzhi-v8530.conf", "deploy/nginx-shuzhi-api-v8530.conf.example", "deploy/shuzhi-v8533-capability-activation.json", "docs/数智供社-v8530-上线执行清单.md", "docs/数智供社-v8530-外部联调验收表.md", "docs/openapi/数智供社-v8533-机构适配协议-v1.openapi.json", "institution-adapters/shared/client.mjs", "scripts/create-shuzhi-production-env.mjs", "scripts/check-shuzhi-production-activation.mjs", "scripts/check-shuzhi-institution-contract.mjs", "scripts/check-shuzhi-institution-client.mjs"];
